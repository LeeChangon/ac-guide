...
import com.ssafy.animal_crossing_nh_guide.api.EventService
import com.ssafy.animal_crossing_nh_guide.api.FirebaseTokenService
...
class RetrofitUtil {
    companion object{
        ...
        val eventService = ApplicationClass.retrofit.create(EventService::class.java);
