...
class MyVillagerAdapter(val context: Context, val childFragmentManager: FragmentManager, val mainActivityViewModel: MainActivityViewModel) : RecyclerView.Adapter<MyVillagerAdapter.ViewHolder>() {
