...
private const val TAG = "SeaCreatureMonthFragment_싸피"
class SeaCreatureMonthFragment : BaseFragment<FragmentSeaCreatureMonthBinding>(FragmentSeaCreatureMonthBinding::bind, R.layout.fragment_sea_creature_month) {
